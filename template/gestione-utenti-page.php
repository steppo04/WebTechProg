        ...
        <div class="card-body p-0"> <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4"><strong><?php echo htmlspecialchars($utente["username"]); ?></strong></td>
                            ...
                            <td class="text-end pe-4">
                                <form method="POST" action="gestione-utenti.php">
                                    ...
                                    <?php if($utente["stato"] == "attivo"): ?>
                                        <button type="submit" name="azione" value="blocca" class="btn btn-sm btn-outline-danger">Blocca</button>
                                    <?php else: ?>
                                        <button type="submit" name="azione" value="sblocca" class="btn btn-sm btn-outline-success">Sblocca</button>
                                    <?php endif; ?>
                                </form>
                            </td>
                        </tr>
