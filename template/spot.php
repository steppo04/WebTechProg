        ...
        <div class="col-md-8">
            <article class="card shadow-sm mb-4">
                ...
                <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                    ...
                    $labelPreferito = $templateParams["isPreferito"] ? "Rimuovi dai preferiti" : "Salva nei preferiti";
                    ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-sm-6">
                            <h3 class="h6 text-muted small fw-bold">Dettagli Pubblicazione</h3>
                            ...
                            <div class="list-group-item border-start border-danger border-4 mb-2 shadow-sm rounded">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <img src="<?php echo htmlspecialchars($imgCommento); ?>" alt=""
                                ...
                                <p class="mb-1 small"> <span class="visually-hidden">Testo del commento:</span> <?php echo htmlspecialchars($commento["testo"]); ?></p>
                    ...
                    <?php if (isset($_GET["rspTo"])):
                        ...
                        <div
                            ...
                            <p class="mb-0 text-muted small text-truncate">
                                "<?php echo htmlspecialchars(string: $commentoDaRispondere["testo"]); ?>"
                            </p>
                        </div>
                    <?php endif; ?>
